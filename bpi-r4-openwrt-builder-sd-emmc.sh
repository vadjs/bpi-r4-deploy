...
\cp -r ../my_files/456-w-add-bpi-r4-8g-dts.patch target/linux/mediatek/patches-6.12/
...
#mkdir -p package/utils/fitblk/patches
#\cp -r ../my_files/999-w-fit-nvme-sysupgrade.patch package/utils/fitblk/patches
